...
2. **Adicione a pergunta 'Qual tipo de Teletrabalho você está solicitando?'**
    ...
    |**Question label**           | Qual tipo de Teletrabalho você está solicitando? 
    |**Mandatory**                | Checked 
...
3. **Adicione a pergunta 'Número de Dias por Semana?' usando um método diferente.**
    ...
    |**Question label**	             | Número de Dias por Semana?
    |**Name**                         | days_per_week
...
5. **Adicione a pergunta final: Qual é a razão para o Teletrabalho?**
    ...
    |**Question label**           | Qual é a razão para o Teletrabalho? 
    |**Name**                     | justification
    |**Mandatory**                | Checked 
