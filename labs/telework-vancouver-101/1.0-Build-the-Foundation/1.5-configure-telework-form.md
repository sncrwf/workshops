...
2.  **Volte para a visualização 'Data -> Spreadsheet'.**
    1. Clique nos três pontos ao lado do pill **Data**.
    2. Clique em **Spreadsheet**.
   ![](../images/2023-10-19-18-45-29.png)

3.  Clique no ícone de escape ao lado de um registro para abri-lo.
![](../images/2023-11-08-19-44-43.png)

1.  **Confirme que o novo formulário atende aos requisitos dos usuários fulfillers.**
