...
4. Crie o fluxo com as seguintes informações:
    ...
    |**Campo** | **Valor** |
    |-|-|
    |**Name** | Aprovação de Caso de Teletrabalho |
    |**Description** | Aprovar e atender novos casos de teletrabalho.
...
7. **Adicione um gatilho para determinar quando e como o Fluxo será executado.**
   1. Clique "Edit flow".
   ![](../images/2025-11-12-15-04-43.png)
    2. Clique em **Add a trigger** no canto superior esquerdo da tela do designer de fluxos.
    ![](../images/2023-11-03-15-13-44.png)
    3. Selecione **Created** na seção Registro.
    ![](../images/2023-11-03-15-14-42.png)
    4. Clique no drop-down 'Table'.
    ![](../images/2023-10-04-15-24-53.png)
    5. Digite `telework case` e clique na tabela **Telework Case**.
    ![](../images/2023-11-03-15-16-06.png)
    6. Clique em <span className="button-purple">Done</span> para fechar o gatilho.
...
11. **Adicione a Ação Criar um Ticket.**
    ...
    **Resultado:**
    ...
    |-------------------------| --------------
    |**Short description**   | Acesso a VPN |
...
12. **Adicione e configure a Ação 'Send Email'.**
    ...
    **Os e-mails precisam estar associados a um registro alvo para rastreamento.**
    ...
    13. No campo **Body**, digite `Caro ` _(Certifique-se de incluir o espaço extra no final)_.
    ...
    :::info
    Se você soltar o Data Pill antes da palavra 'Caro ', você pode arrastá-lo e soltá-lo no local correto.
    ...
    **RESULTADO:**
    ...
    17. Digite `Sua solicitação ` _(Certifique-se de incluir o espaço extra no final)_.
    ...
    20. Digite `<espaço>foi aprovada.` após o Data Pill. _(Certifique-se de incluir um espaço extra antes das palavras)_.
...
1.  Clique em <span className="button-purple">Activate</span>. Isso torna o Fluxo 'ativo' no aplicativo.  

2.  Na caixa de Confirmação, clique no botão <span className="button-purple">Activate</span>.

3.  Feche a aba do Fluxo no App Engine Studio.
