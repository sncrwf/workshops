...
11. Não iremos adicionar nenhuma **Question**, por isso iremos avançar para **Client Script**. Clique em <span className="button-purple">Continue to Client Script</span>.
    ![](../images/2025-10-21-11-03-07.png)

11. Não iremos adicionar nenhum **Client Script**, por isso iremos avançar para **Settings**. Clique em <span className="button-purple">Continue to Settings</span>.
    ![](../images/2025-10-21-11-04-15.png)

12. Como iremos precisar do documento, vamos marcar a opção **"Make attachment mandatory"**.
    Clique em <span className="button-purple">Continue to Access</span>.
    ![](../images/2024-12-09-18-36-05.png)

13. Clique em "Browse" na sessão **"Available for"**.
...
15. Clique no botão <span className="button-purple">Save</span>
    ![](../images/2025-10-21-11-07-32.png)

16. Clique no botão <span className="button-white-purple-border">Preview</span>.
    ![](../images/2025-10-21-11-08-01.png)

17. Visualize como será a experiência para o usuário em 3 tipos de plataforma: Portal, Now Mobile e Virtual Agent
    ![](../images/2024-12-09-18-42-19.png)

18. Feche a janela de preview (X).
    ![](../images/2024-12-09-18-43-01.png)

17. Clique em <span className="button-purple">Continue to Review and Submit</span>.
    ![](../images/2024-12-09-18-39-38.png)


19. Clique no botão <span className="button-purple">Submit</span>
    ![](../images/2024-12-09-18-43-54.png)

20. Clique no botão <span className="button-purple">Return to my application</span>
