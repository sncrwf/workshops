...
7. **Adicione um gatilho para determinar quando e como o Fluxo será executado.**
   1. Destrave o flow clicando em **Edit flow**.
   ![](../images/2025-10-21-11-14-59.png)
    2. Clique em **Add a trigger** no canto superior esquerdo da tela do designer de fluxos.
    ![](../images/2024-12-10-13-31-55.png)
    3. Selecione **Created or Updated** na seção Registro.
    ![](../images/2024-12-10-13-32-33.png)
    4. Clique no drop-down 'Table'.
    5. Digite `Visitantes` e clique na tabela *x_snc_acme_acces_0_visitantes*.
    6. Clique em `+ Add filters`
    ![](../images/2024-12-10-13-34-35.png)
    7. Adicione os seguintes critérios:
    ...
    8. Clique em <span className="button-purple">Done</span> para fechar o gatilho.
...
12. Clique em <span className="button-purple">Activate</span> à esquerda do botão Save. Isso torna o Fluxo 'ativo' no aplicativo.  

13. Na caixa de Confirmação, clique no botão <span className="button-purple">Activate</span>.
