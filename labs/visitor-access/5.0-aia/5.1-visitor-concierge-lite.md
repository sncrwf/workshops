...
title: "5.1. Criar Agente de IA"
pagination_label: "5.1. Criar Agente de IA"
sidebar_label: "5.1. Criar Agente de IA"
...
8. Clique em **Add tool** e selecione **Record Operations**
   ![](../images/2025-10-31-12-46-59.png)
     - **Select a type of record operation to add:** `A new record operation`
     ...
     - **Inputs:** 
       - **Input name:** `number` | **Description:** `Número da solicitação de visita`
   ...
   ![](../images/2025-11-02-12-20-12.png)
   ![](../images/2025-11-02-12-20-22.png)
   ![](../images/2025-11-02-12-26-25.png)

   - Clique em **Add**

9.  Após adicionar e salvar as configurações de cada ferramenta, clique em **Save and continue**.
   ![](../images/2025-10-31-12-40-12.png)
10. Em **Define triggers**, clique em **Add trigger** e configure:
   ...
   **Method of defining sys_user:** `Use a new custom script`
     ...
     - **Assistant:** `Now Assist in Virtual Agent (default)`
     - **Portal:** `Service Portal`
     - **Show Notification:** `Yes`
   ![](../images/2025-11-02-12-23-35.png)
   ![](../images/2025-11-02-12-23-47.png)
    - Clique em **Add**

11. Após adicionar e salvar as configurações, clique em **Save and continue**.
   ![](../images/2025-10-31-12-40-12.png)

12. Em **Define availability**, ajuste:
...
13. Finalize clicando em **Save and Test**.
