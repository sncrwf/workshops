...
3. Preencha os campos a seguir e depois clique em **Create** (3)
   
   | Campo         | Valor                                                        |
   |---------------|--------------------------------------------------------------|
   | **(1) Connection alias name** | `VisitorAppConnection`                       |
   | **(2) Authentication Configuration Template** | `Api Key Template`           |
